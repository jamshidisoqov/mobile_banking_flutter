mixin BaseResponse<T> {
  ...
  BaseResponse<T> onServerError(void Function(Exception) block) {
    if (this is ServerError) block((this as ServerError).exception);
    return this;
  }
...
class ServerError<T> with BaseResponse<T> {
  Exception exception;
